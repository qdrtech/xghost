...
| `KNOB_FONT`          | `generated/hypr/knobs.conf`, `misc:font_family` of Hyprland, `generated/ghostty/font.conf`, `font-family` of Ghostty, `generated/waybar/knobs.css`, the family the bar draws in, `generated/rofi/knobs.rasi`, the family the launcher draws in, and `generated/swaync/knobs.css`, the family the notification centre draws in. Not the lock screen. |
...
`KNOB_FONT` reaches the compositor, the terminal, the bar, the launcher and the
notification centre. It does not reach `hyprlock`, which draws the clock and
your user name in the family written out in `config/hypr/hyprlock.conf`.
